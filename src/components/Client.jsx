  ...
  return (
    <tr className='border-b'>
      ...
      <td className="p-5 flex gap-2">
        <button type="button" className="text-blue-800 hover:text-blue-700 uppercase font-bold text-xs">
            Edit
        </button>
        <button type="button" className="text-red-800 hover:text-red-700 uppercase font-bold text-xs">
            Delete
        </button>
      </td>
    </tr>
